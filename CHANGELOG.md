# Easy Markdown Editor Changelog
...
## [1.1.0] - 2026-04-15
#### Added
- Built-in `att`, `note`, `tip`, `warn`, and `video` fenced-code blocks rendered as callouts / responsive video embeds
- Toolbar buttons `attention`, `note`, `tip`, `warning`, `video` wired to the new actions
- `example/index_alerts_video.html` demonstrating the new blocks
- `src/css/alert.css` and `src/css/video.css` bundled into `dist/easymde.min.css`
